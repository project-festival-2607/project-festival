...
public class AdminMemberController {
  ...
  public AdminActionResponse suspendMember(@PathVariable Long memberId,
    ...
    boolean isChanged = adminMemberService.suspendMember(memberId, reason);
  ...
  public AdminActionResponse unsuspendMember(@PathVariable Long memberId) {
    boolean isChanged = adminMemberService.unsuspendMember(memberId);
    return AdminActionResponse.builder()
      .result(isChanged)
      .message(isChanged
  ...
  public AdminActionResponse removePhoneVerification(@PathVariable Long memberId) {
    adminMemberService.removePhoneVerification(memberId);
    return AdminActionResponse.builder()
      .result(true)
  ...
  public AdminActionResponse addPhoneWithVerification(@PathVariable Long memberId,
    ...
    boolean isChanged = adminMemberService.addPhoneWithVerification(memberId, phone);
    return AdminActionResponse.builder()
      .result(isChanged)
      .message(isChanged
  ...
  public AdminActionResponse removeBusinessRegistration(@PathVariable Long memberId) {
    boolean suspended = adminMemberService.removeBusinessRegistration(memberId);
    return AdminActionResponse.builder()
      .result(true)
  ...
  public AdminActionResponse addBusinessRegistration(@PathVariable Long memberId,
    ...
    boolean isChanged = adminMemberService.addBusinessRegistration(memberId, businessNumber);
    return AdminActionResponse.builder()
      .result(isChanged)
      .message(isChanged
