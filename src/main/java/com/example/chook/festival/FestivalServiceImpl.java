...
//    DB에서 API 요청 후 백그라운드에서 동기화
    ...
    public void run(@NonNull ApplicationArguments args) throws Exception{
        ...
        try {
            String url = "https://apis.data.go.kr/B551011/KorService2/searchFestival2?numOfRows=36&MobileOS=WEB&MobileApp=CHUCK&_type=json&arrange=R&eventStartDate=20260101&serviceKey=" + apiKey;
